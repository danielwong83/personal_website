import wave from '../images/wave.gltf'
...
export default function Model({ ...props }) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(wave);
...
useGLTF.preload(wave)





// import wavey from '../images/wavey.glb'
...
// export default function Model({ ...props }) {
//   const group = useRef()
//   const { nodes, materials, animations } = useGLTF(wavey)
//   const { actions } = useAnimations(animations, group)
//   return (
//     <group ref={group} {...props} dispose={null}>
//       <group name="Scene">
